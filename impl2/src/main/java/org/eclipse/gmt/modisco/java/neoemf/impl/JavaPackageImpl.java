...
import org.eclipse.gmt.modisco.java.meta.JavaPackage;;import javax.enterprise.context.ApplicationScoped;
...
public class JavaPackageImpl extends EPackageImpl implements JavaPackage {
	 ...
	 * <!-- end-user-doc -->
	 * //@see Registry
	 * //@see import org.eclipse.gmt.modisco.java.meta.JavaPackage;#eNS_URI
	 * //@see #init()
	 * @generated
	 */
	...
	public static JavaPackage init() {
		if (isInited) return (JavaPackage) Registry.INSTANCE.getEPackage(JavaPackage.eNS_URI);

		// Obtain or create and register package
		JavaPackageImpl theJavaPackage = (JavaPackageImpl)(Registry.INSTANCE.get(eNS_URI) instanceof JavaPackageImpl ? Registry.INSTANCE.get(eNS_URI) : new JavaPackageImpl());
		...
		Registry.INSTANCE.put(JavaPackage.eNS_URI, theJavaPackage);
