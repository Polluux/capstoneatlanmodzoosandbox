 ...
 * </ul>
 *
 * //@see import org.eclipse.gmt.modisco.java.meta.JavaPackage;#getManifestEntry()
 * @model
...
public interface ManifestEntry extends PersistentEObject {
	 ...
	 * //@see #setName(String)
	 * //@see import org.eclipse.gmt.modisco.java.meta.JavaPackage;#getManifestEntry_Name()
	 ...
	 * //@see import org.eclipse.gmt.modisco.java.meta.JavaPackage;#getManifestEntry_Attributes()
