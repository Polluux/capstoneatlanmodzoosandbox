 ...
 * </ul>
 *
 * //@see import org.eclipse.gmt.modisco.java.meta.JavaPackage;#getManifestAttribute()
 * @model
...
public interface ManifestAttribute extends PersistentEObject {
	 ...
	 * //@see #setKey(String)
	 * //@see import org.eclipse.gmt.modisco.java.meta.JavaPackage;#getManifestAttribute_Key()
	 ...
	 * //@see #setValue(String)
	 * //@see import org.eclipse.gmt.modisco.java.meta.JavaPackage;#getManifestAttribute_Value()
	 * @model unique="false" required="true" ordered="false"
	 * @generated
	 */
	String getValue();
