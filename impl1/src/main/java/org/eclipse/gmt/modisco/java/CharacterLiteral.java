 ...
 * </p>
 * <ul>
 *   <li>{@link CharacterLiteral#getEscapedValue <em>Escaped Value</em>}</li>
 * </ul>
 *
 * @see org.eclipse.gmt.modisco.java.meta.JavaPackage#getCharacterLiteral()
 * @model
 * @generated
 */
public interface CharacterLiteral extends Expression {
	 ...
	 * @see org.eclipse.gmt.modisco.java.meta.JavaPackage#getCharacterLiteral_EscapedValue()
	...
	/**
	 * Sets the value of the '{@link CharacterLiteral#getEscapedValue <em>Escaped Value</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
