 ...
 * </p>
 * <ul>
 *   <li>{@link AbstractVariablesContainer#getType <em>Type</em>}</li>
 *   <li>{@link AbstractVariablesContainer#getFragments <em>Fragments</em>}</li>
 * </ul>
 *
 * @see org.eclipse.gmt.modisco.java.meta.JavaPackage#getAbstractVariablesContainer()
 * @model abstract="true"
 * @generated
 */
public interface AbstractVariablesContainer extends ASTNode {
	 ...
	 * @see org.eclipse.gmt.modisco.java.meta.JavaPackage#getAbstractVariablesContainer_Type()
	...
	/**
	 * Sets the value of the '{@link AbstractVariablesContainer#getType <em>Type</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see org.eclipse.gmt.modisco.java.meta.JavaPackage#getAbstractVariablesContainer_Fragments()
